<template>
  ...
  <div class="fixed bottom-0 left-0 w-full h-16 p-5 pb-4 text-left align-top bg-white">
    <div class="relative">
      ...
      <!-- Current Position -->
      <div class="float-left w-16 mt-0 ml-5 text-lg leading-3 text-gray-400 lg:mt-1 h-7">
      ...
      <!-- Duration -->
      <div class="float-left mt-0 ml-8 text-lg leading-3 text-gray-400 lg:mt-1 h-7 w-7">
